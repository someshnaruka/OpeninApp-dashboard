...
navigate("/");
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row md:justify-between justify-start gap-6 lg:gap-0  items-center w-full h-screen">
       ...
       <div className="w-full flex lg:flex-col flex-row justify-between items-center h-full ">
        ...
        <div className="flex flex-col md:w-2/3 w-full justify-between gap-2 items-start"><h1 className=" w-full text-3xl md:text-4xl text-black font-monst font-bold">Sign In</h1>
          <p className="text-black font-lato font-normal text-base  w-full ">Sign in to your account</p></div>
          ...
          <div className="flex bg-[#FFFFFF] flex-col justify-between items-start rounded-xl md:w-2/3 w-full p-6 gap-6">
            ...
            <p className="text-[#346BD4] font-lato text-base font-normal">Forgot password?</p>
          ...
          <p className="text-base font-normal font-lato text-[#858585] text-center w-full">Don’t have an account? <span className="text-base font-normal font-lato text-[#346BD4] cursor-pointer" onClick={()=>navigate("/register")}>Register here</span></p>
